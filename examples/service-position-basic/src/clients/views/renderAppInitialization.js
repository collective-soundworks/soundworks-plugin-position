...
import './elements/service-position';
...
const renderScreen = {
    ...
    return html`
      ...
      >
        <section class="half-screen aligner">
          <app-header title="${config.app.name}" subtitle="${config.app.author}" />
        </section>
        <section class="half-screen aligner">
  ...
  default(services, config, containerInfos) {
    return html`
      <div class="screen">
        <section class="half-screen aligner">
          <app-header title="${config.app.name}" subtitle="${config.app.author}"></app-header>
        </section>
